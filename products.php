...
// Fetch all active products with their category and seller
$stmt = $pdo->query('SELECT p.id, p.title, p.price, p.description, p.image_path, p.stock, c.name AS category_name FROM products p JOIN categories c ON p.category_id = c.id WHERE p.status = "active" ORDER BY p.created_at DESC');
...
<body>
    ...
    <nav class="top-nav">
        ...
        <div class="user-actions">
            <a href="/cart/view.php" class="user-link">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-actions">
                            ...
                            <form action="cart/add.php" method="POST" style="flex:1;display:flex;gap:8px;">
                            ...
                            <?php else: ?>
                                <button class="cart-btn" disabled style="opacity:0.6;cursor:not-allowed;">
