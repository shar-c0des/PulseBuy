...
if (
    ...
    if (isset($_FILES['product_image']) && $_FILES['product_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!in_array($fileExtension, $allowedfileExtensions)) {
            ...
            $uploadFileDir = __DIR__ . '/../src/uploads/products/';
...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-left">
            ...
            <div class="nav-links">
                <a href="seller_dashboard.php" class="nav-link active">Dashboard</a>
                <a href="products.php" class="nav-link">Products</a>
                <a href="orders/sales.php" class="nav-link">Orders</a>
